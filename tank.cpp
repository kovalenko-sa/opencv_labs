...
{
  Mat3b background = imread("/home/semyon/opencv_study/field.jpg");
  Mat4b tank = imread("/home/semyon/opencv_study/tank.png", IMREAD_UNCHANGED);
  Mat4b bullet = imread("/home/semyon/opencv_study/shell7.png", IMREAD_UNCHANGED);
